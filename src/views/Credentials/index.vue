  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      <content-loader
        ...
        height="50px"
      />
      <div v-else class="flex py-3 pl-5 pr-15 mt-2 rounded justify-between items-center bg-brand-gray w-full lg:w-1/2">
      ...
      <content-loader
        ...
        height="50px"
      />
      <div v-else class="flex py-3 pl-5 pr-20 mt-2 rounded items-center bg-brand-gray w-full lg:w-2/3 overflow-x-scroll">
        <span v-if="state.hasError">Erro ao carregar o script</span>
        <pre v-else>&lt;script src="https://vslourenco-feedbacker-widget.netlify.app?api_key={{ store.User.currentUser.apiKey }}"&gt;&lt;/script&gt;</pre>
      </div>
