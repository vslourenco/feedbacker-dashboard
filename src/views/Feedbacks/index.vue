  ...
  <div class="flex justify-center w-full pb-20">
    <div class="w-4/5 max-w-6xl py-10 grid grid-cols-4 gap-2">
      ...
      <div class="col-span-3 px-10 pt-20">
        ...
        <p v-if="!state.feedbacks.length && !state.isLoading && !state.hasError" class="text-lg text-center text-gray-800 font-regular">
          Ainda nenhum feedback recebido 8)
        </p>
...
export default {
  components: {
    HeaderLogged, Filters, FiltersLoading, FeedbackCard, FeedbackCardLoading,
  },
  setup() {
